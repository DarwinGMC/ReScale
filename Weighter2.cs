...
public class Weighter2 : MonoBehaviour
{
    ...
    {
        UpdateText();
        door1.position = new Vector3(19.2f, 0.5f, 14);
        door1.rotation = Quaternion.Euler(0f, 180f, 0f);
    }
    ...
    void Update()
    {
        ...
        {
            door1.position = new Vector3(19.2f, 0.5f, 14);
            door1.rotation = Quaternion.Euler(0f, 85f, 0f);
        }
        else
        {
            door1.position = new Vector3(19.2f, 0.5f, 14);
